...
<script>
  export default {
    ...
    methods: {
      getWebsiteConfig() {
        this.axios.get("/websiteConfig/core/getWebsiteConfig").then(response => {
          console.log("result", response.data)
          this.websiteConfigForm = response.data.data.data;
        });
      },
      handleClick(tab) {
        console.log(tab);
      ...
      handleWebsiteAvatarSuccess(response) {
        this.axios.get("/api/oss/file/removeWebImg")
        this.websiteConfigForm.websiteAvatar = response.data.url
      ...
      handleUserAvatarSuccess(response) {
        this.axios.get("/api/oss/file/removeUserImg")
        this.websiteConfigForm.userAvatar = response.data.url
        if (response.data.url !== null) {
          this.$message.success(response.message);
        } else {
          this.$message.error("上传失败");
      ...
      handleTouristAvatarSuccess(response) {
        this.axios.get("/api/oss/file/removeGuestImg")
        this.websiteConfigForm.touristAvatar = response.data.url
        if (response.data.url !== null) {
          this.$message.success(response.message);
        } else {
          this.$message.error("上传失败");
      ...
      handleWeiXinSuccess(response) {
        this.axios.get("/api/oss/file/removeWeChatImg")
        this.websiteConfigForm.weiXinQRCode = response.data.url
        if (response.data.url !== null) {
          this.$message.success(response.message);
        } else {
          this.$message.error("上传失败");
      ...
      handleAlipaySuccess(response) {
        this.axios.get("/api/oss/file/removeAlipayImg")
        this.websiteConfigForm.alipayQRCode = response.data.url
        if (response.data.url !== null) {
          this.$message.success(response.message);
        } else {
          this.$message.error("上传失败");
      ...
      updateWebsiteConfig() {
        this.axios
          .put("/websiteConfig/core/updateWebsiteConfig", this.websiteConfigForm)
          .then(({ data }) => {
            if (data.code === 200) {
              this.$notify.success({
                title: "成功",
