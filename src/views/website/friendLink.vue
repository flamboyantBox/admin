...
export default {
  ...
  methods: {
    ...
    deleteLink(id) {
      ...
      console.log(param)
      this.axios.delete("/friendLink/core/removeFriendLink", param).then(({ data }) => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
    ...
    addOrEditLinks() {
      ...
      this.axios.post("/friendLink/core/saveOrUpdateFriendLink", this.linkForm).then(({ data }) => {
        if (data.code === 200) {
          this.$notify.success({
            title: "成功",
            message: data.message
    ...
    listLinks() {
      ...
      this.axios.get("/friendLink/core/linkList", {params: params}).then(({ data }) => {
        console.log("find", this.keywords)
        this.linkList = data.data.list;
