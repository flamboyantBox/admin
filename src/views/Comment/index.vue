  ...
  export default {
    ...
    methods: {
      ...
      updateCommentReview(id) {
        ...
        this.axios.put("/comment/core/updateCommentsReview", param).then(({ data }) => {
          if (data.code === 200) {
            this.$notify.success({
              title: "成功",
      ...
      deleteComments(id) {
        ...
        console.log("id", id)
        this.axios.delete("/comment/core/deleteComments", param).then(({ data }) => {
      ...
      listComments() {
        ...
        this.axios.get("/comment/core/listCommentBackDTO", {params: params}).then(({ data }) => {
          console.log("data", data)
          this.commentList = data.data.commentBackDTOList;
