  ...
  export default {
    ...
    methods: {
      ...
      updateAvatar(response) {
        this.axios.delete("/api/oss/file/remove")
        this.infoForm.avatar = response.data.url
      ...
      updateInfo() {
        ...
        console.log("result", this.infoForm)
        this.axios.post("/userInfo/core/updateInfo", this.infoForm).then(response => {
      ...
      userInfo(){
        this.axios.get("/userInfo/core/user")
          .then((response) => {
            this.infoForm = response.data.data.userInfo;
          })
      },
      updatePassword() {
        ...
        this.axios.put("/userAuth/core/updatePassword", this.passwordForm).then(res => {
          ...
          if (res.data.code === 200) {
            ...
            document.cookie = "userInfo" + "=" + "; expires=Thu, 01-Jan-70 00:00:01 GMT";
