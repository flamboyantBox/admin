  ...
  export default {
    ...
    methods: {
      ...
      searchCategories() {
        ...
        this.axios.post("/category/core/search", params).then(({ data }) => {
          console.log(params);
          this.categoryList = data.data.searchList;
      ...
      deleteCategory(id) {
        ...
        this.axios.delete("/category/core/deleteCategories", param).then(({ data }) => {
          if (data.code === 200) {
            this.$notify.success({
              title: "成功",
      ...
      addOrEditCategory() {
        ...
        this.axios.post("/category/core/saveOrUpdate", this.categoryForm).then((response) => {
