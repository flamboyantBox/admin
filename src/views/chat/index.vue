      ...
      <el-table-column label="操作" width="160" align="center">
        <template slot-scope="scope">
          <el-popconfirm
            ...
            title="确定删除吗？"
            @onConfirm="deleteChatRecord(scope.row.id)"
          >
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        this.axios.get("/chatRecord/core/chatList").then(res => {
          this.chatRecordList = res.data.data.chatRecordList;
      ...
      deleteChatRecord(id) {
        ...
        console.log("start")
        this.axios.delete("/chatRecord/core/chatDelete", param).then(({ data }) => {
          if (data.code === 200) {
            this.$notify.success({
              title: "成功",
