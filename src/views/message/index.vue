  ...
  export default {
    ...
    methods: {
      ...
      deleteMessage(id) {
        ...
        this.axios.delete("/message/core/messageDelete", param).then(({ data }) => {
          if (data.code === 200) {
            this.$notify.success({
              title: "成功",
      ...
      updateMessageReview(id) {
        ...
        param.isReview = 1;
        this.axios.put("/message/core/messageReview", param).then(({ data }) => {
          if (data.code === 200) {
            this.$notify.success({
              title: "成功",
              message: data.message
      ...
      listMessages() {
        ...
        this.axios.post("/message/core/messageBackList", params).then(({ data }) => {
          this.messageList = data.data.messageBackList;
